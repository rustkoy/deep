...
def parse_args() -> None:
    ...
    program.add_argument('--execution-provider', help='available execution provider (choices: cpu, ...)', dest='execution_provider', default=['dml'], choices=suggest_execution_providers(), nargs='+')
